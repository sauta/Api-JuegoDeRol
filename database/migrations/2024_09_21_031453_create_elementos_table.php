...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('elementos', function (Blueprint $table) {
            $table->integer('ID_ELEMENTO', true);
            $table->string('ELEMENTO', 100)->comment('NORMAL Y ELEMENTOS  MAGICOS AIRE, FUEGO, TIERRA, AGUA, MADERA, VENENO, HIELO, ILUSION, CRISTAL, METAL, LUZ, ELECTRICIDAD y CURACION');
